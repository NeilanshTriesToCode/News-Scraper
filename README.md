...
- **CheerioJS**: to refer to HTML contents of the webpage retrieved using **Puppeteer**. It works just like jQuery, and elements of the HTML webpage could be retrieved using the same syntax. It was thus useful in retrieving the "News-cards" elements and their attributes which consisted of sub-elements, news headlines, links, etc. Inspecting the webpage ***(Ctrl+Shitf+I)*** highly recommended to better understand the HTML structure of the webpage.
